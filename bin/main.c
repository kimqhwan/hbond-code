...
//     time_t now;            
       ...
       int i, nsolventtype, nsolutetype, node1Start, node2Start, pbc;
       ...
       double s1s1v6[50], s2s2v6[50], s3s3v6[50], s1s2v6[50], s1s3v6[50], s2s3v6[50];
       double s1as1bBD[50], s2as2bBD[50], s3as3bBD[50], s12as12bBD[50], s13as13bBD[50], s23as23bBD[50];
       ...
       double s1t1cutoff[50], s1t2cutoff[50], s2t1cutoff[50], s2t2cutoff[50], s3t1cutoff[50], s3t2cutoff[50];
       ...
       // Dummy value for .gro file
       int residue_num, atom_num;
       char residue_name[FLN];
 ...
 // If GRAPH SOLVENT1 SOLVENT1 requested
  ...
  if(gs1s1 == 1)
  {
    ...
    for(i=0; i < s1s1hbdn; i++){
      if(fscanf(fd, "%d %d %lf", &s1a[i], &s1b[i], &s1as1bBD[i]) != 3){
    ...
    for(i=0; i < s1s1hban; i++){
      if(fscanf(fd, "%d %d %d %d %d %lf", &s1s1v1[i], &s1s1v2[i], &s1s1v3[i], &s1s1v4[i], &s1s1v5[i], &s1s1v6[i]) != 6){
 ...
 // If GRAPH SOLVENT2 SOLVENT2 requested
  ...
  if(gs2s2 == 1)
  {
    ...
    for(i=0; i < s2s2hbdn; i++){
      if(fscanf(fd, "%d %d %lf", &s2a[i], &s2b[i], &s2as2bBD[i]) != 3){
    ...
    for(i=0; i < s2s2hban; i++){
      if(fscanf(fd, "%d %d %d %d %d %lf", &s2s2v1[i], &s2s2v2[i], &s2s2v3[i], &s2s2v4[i], &s2s2v5[i], &s2s2v6[i]) != 6){
 ...
 // If GRAPH SOLVENT3 SOLVENT3 requested
  ...
  if(gs3s3 == 1)
  {
    ...
    for(i=0; i < s3s3hbdn; i++){
      if(fscanf(fd, "%d %d %lf", &s3a[i], &s3b[i], &s3as3bBD[i]) != 3){
    ...
    for(i=0; i < s3s3hban; i++){
      if(fscanf(fd, "%d %d %d %d %d %lf", &s3s3v1[i], &s3s3v2[i], &s3s3v3[i], &s3s3v4[i], &s3s3v5[i], &s3s3v6[i]) != 6){
 ...
 // If GRAPH SOLVENT1 SOLVENT2 requested
  ...
  if(gs1s2 == 1)
  {
    ...
    for(i=0; i < s1s2hbdn; i++){
      if(fscanf(fd, "%d %d %lf", &s12a[i], &s12b[i], &s12as12bBD[i]) != 3){
    ...
    for(i=0; i < s1s2hban; i++){
      if(fscanf(fd, "%d %d %d %d %d %lf", &s1s2v1[i], &s1s2v2[i], &s1s2v3[i], &s1s2v4[i], &s1s2v5[i], &s1s2v6[i]) != 6){
 ...
 // If GRAPH SOLVENT1 SOLVENT3 requested
  ...
  if(gs1s3 == 1)
  {
    ...
    for(i=0; i < s1s3hbdn; i++){
      if(fscanf(fd, "%d %d %lf", &s13a[i], &s13b[i], &s13as13bBD[i]) != 3){
    ...
    for(i=0; i < s1s3hban; i++){
      if(fscanf(fd, "%d %d %d %d %d %lf", &s1s3v1[i], &s1s3v2[i], &s1s3v3[i], &s1s3v4[i], &s1s3v5[i], &s1s3v6[i]) != 6){
...
// If GRAPH SOLVENT1 SOLUTE1 requested
  ...
  if(gs1t1 == 1)
  {
    ...
    for(i=0; i < s1t1cutoffnum; i++){
      if(fscanf(fd, "%d %d %lf", &s1t1a[i], &s1t1b[i], &s1t1cutoff[i]) != 3){
...
// If GRAPH SOLVENT1 SOLUTE2 requested
  ...
  if(gs1t2 == 1)
  {
    ...
    for(i=0; i < s1t2cutoffnum; i++){
      if(fscanf(fd, "%d %d %lf", &s1t2a[i], &s1t2b[i], &s1t2cutoff[i]) != 3){
 ...
 // If GRAPH SOLVENT2 SOLVENT3 requested
  ...
  if(gs2s3 == 1)
  {
    ...
    for(i=0; i < s2s3hbdn; i++){
      if(fscanf(fd, "%d %d %lf", &s23a[i], &s23b[i], &s23as23bBD[i]) != 3){
    ...
    for(i=0; i < s2s3hban; i++){
      if(fscanf(fd, "%d %d %d %d %d %lf", &s2s3v1[i], &s2s3v2[i], &s2s3v3[i], &s2s3v4[i], &s2s3v5[i], &s2s3v6[i]) != 6){
...
// If GRAPH SOLVENT2 SOLUTE1 requested
  ...
  if(gs2t1 == 1)
  {
    ...
    for(i=0; i < s2t1cutoffnum; i++){
      if(fscanf(fd, "%d %d %lf", &s2t1a[i], &s2t1b[i], &s2t1cutoff[i]) != 3){
...
// If GRAPH SOLVENT2 SOLUTE2 requested
  ...
  if(gs2t2 == 1)
  {
    ...
    for(i=0; i < s2t2cutoffnum; i++){
      if(fscanf(fd, "%d %d %lf", &s2t2a[i], &s2t2b[i], &s2t2cutoff[i]) != 3){
...
// If GRAPH SOLVENT3 SOLUTE1 requested
  ...
  if(gs3t1 == 1)
  {
    ...
    for(i=0; i < s3t1cutoffnum; i++){
      if(fscanf(fd, "%d %d %lf", &s3t1a[i], &s3t1b[i], &s3t1cutoff[i]) != 3){
...
// If GRAPH SOLVENT3 SOLUTE2 requested
  ...
  if(gs3t2 == 1)
  {
    ...
    for(i=0; i < s3t2cutoffnum; i++){
      if(fscanf(fd, "%d %d %lf", &s3t2a[i], &s3t2b[i], &s3t2cutoff[i]) != 3){
...
if((ws == 1 && watid == 1) || (t1watdip == 1 && watid == 1) || (t2watdip == 1 && watid == 1)){
  ...
  if(ntest != 3) { printf("SOLUTE1(2) WATER DIPOLE ORIENTATIONS/WATER STRUCTURES: Solvent 1 is NOT WATER\n"); exit(-1); }
     ...
     if(strcmp(slvntatmtest[0], "O") == 0 || strcmp(slvntatmtest[0], "H") == 0 || strcmp(slvntatmtest[0], "OW") == 0 || strcmp(slvntatmtest[0], "HW") == 0 || strcmp(slvntatmtest[0], "HW1") == 0 || strcmp(slvntatmtest[0], "HW2") == 0) cks = cks + 1; 
     if(strcmp(slvntatmtest[1], "O") == 0 || strcmp(slvntatmtest[1], "H") == 0 || strcmp(slvntatmtest[1], "OW") == 0 || strcmp(slvntatmtest[1], "HW") == 0 || strcmp(slvntatmtest[1], "HW1") == 0 || strcmp(slvntatmtest[1], "HW2") == 0) cks = cks + 1; 
     if(strcmp(slvntatmtest[2], "O") == 0 || strcmp(slvntatmtest[2], "H") == 0 || strcmp(slvntatmtest[2], "OW") == 0 || strcmp(slvntatmtest[2], "HW") == 0 || strcmp(slvntatmtest[2], "HW1") == 0 || strcmp(slvntatmtest[2], "HW2") == 0) cks = cks + 1; 
...
// Read Coordinates from the GRO files
...
if((nsolventtype == 1 && nsolutetype == 0) || (nsolventtype == 1 && nsolutetype == 1) || nsolventtype == 2 || nsolventtype == 3)
{
   ...
   // Skip 1 line from top of file : description
   fgets(line,512,fsolvent1);

   if(fscanf(fsolvent1,"%d", &nAtomS1)!=1){
      printf("Cannot read number of atoms in solvent1 GRO file\n");
      exit(-1);
   }
   ...
   // Skip 2 lines from top of file : description, atom number
      rewind(fsolvent1); 
      fgets(line,512,fsolvent1);
      fgets(line,512,fsolvent1);
   for(i=0; i < nAtomS1; i++){
      if(fscanf(fsolvent1, "%d %s %s %d %lf %lf %lf", &residue_num, residue_name, atmTypeS1[i], &atom_num, &atmS1[3*(i+1)-3], &atmS1[3*(i+1)-2], &atmS1[3*(i+1)-1]) != 7){
        printf("Solvent1 GRO file: Cannot read coordinates\n");
        exit(-1);
      }
    } 
   ...
   for(i = 0; i < nsolvent1; i++)
   {
     if(strcmp(slvntatm1[i], atmTypeS1[i]) != 0) {printf("Solvent1 GRO file: Atom types and/or their order do not match with the input file\n"); exit(-1);}
   }

    //Read Last line for Box size
   if(fscanf(fsolvent1, "%lf %lf %lf", &xside, &yside, &zside) != 3){
 
     printf("Solvent1 GRO file: Cannot read box sizes\n");
      exit(-1);
   }
...
if((nsolventtype == 1 && nsolutetype == 1) || (nsolventtype == 1 && nsolutetype == 2))
{
   ...
   if(fscanf(fsolute1,"%d", &nAtomT1)!=1){
      printf("Cannot read number of atoms in solute1 GRO file\n");
      exit(-1);
   }
   ...
   for(i = 0; i < nsolute1; i++)
   {
     if(strcmp(sltatm1[i], atmTypeT1[i]) != 0) {printf("Solute1 GRO file: Atom types and/or their order do not match with the input file\n"); exit(-1);}
   }

    //Read Last line for Box size
   if(fscanf(fsolute1, "%lf %lf %lf", &xside, &yside, &zside) != 3){
 
     printf("Solute1 GRO file: Cannot read box sizes\n");
      exit(-1);
   }
...
if(nsolventtype == 1 && nsolutetype == 2)
{
   ...
   if(fscanf(fsolute2,"%d", &nAtomT2)!=1){
      printf("Cannot read number of atoms in solute2 GRO file\n");
      exit(-1);
   }
   ...
   for(i = 0; i < nsolute2; i++)
   {
     if(strcmp(sltatm2[i], atmTypeT2[i]) != 0) {printf("Solute2 GRO file: Atom types and/or their order do not match with the input file\n"); exit(-1);}
   }

    //Read Last line for Box size
   if(fscanf(fsolute2, "%lf %lf %lf", &xside, &yside, &zside) != 3){
 
     printf("Solute2 GRO file: Cannot read box sizes\n");
      exit(-1);
   }
...
if((nsolventtype == 2 && nsolutetype == 0) || (nsolventtype == 2 && nsolutetype == 1) || (nsolventtype == 2 && nsolutetype == 2) || nsolventtype == 3)
{
   ...
   if(fscanf(fsolvent2,"%d", &nAtomS2)!=1){
      printf("Cannot read number of atoms in solvent2 GRO file\n");
      exit(-1);
   }
   ...
   for(i = 0; i < nsolvent2; i++)
   {
     if(strcmp(slvntatm2[i], atmTypeS2[i]) != 0) {printf("Solvent2 GRO file: Atom types and/or their order do not match with the input file\n"); exit(-1);}
   }

    //Read Last line for Box size
   if(fscanf(fsolvent2, "%lf %lf %lf", &xside, &yside, &zside) != 3){
 
     printf("Solvent2 GRO file: Cannot read box sizes\n");
      exit(-1);
   }
...
if(nsolventtype == 3)
{
   ...
   if(fscanf(fsolvent3,"%d", &nAtomS3)!=1){
      printf("Cannot read number of atoms in solvent3 GRO file\n");
      exit(-1);
   }
   ...
   for(i = 0; i < nsolvent3; i++)
   {
     if(strcmp(slvntatm3[i], atmTypeS3[i]) != 0) {printf("Solvent3 GRO file: Atom types and/or their order do not match with the input file\n"); exit(-1);}
   }

    //Read Last line for Box size
   if(fscanf(fsolvent3, "%lf %lf %lf", &xside, &yside, &zside) != 3){
 
     printf("Solvent3 GRO file: Cannot read box sizes\n");
      exit(-1);
   }
   fclose(fsolvent3);
...
if((swatdip ==1 && watid == 1 && solid == 2) || (swatdip ==1 && watid == 2 && solid == 1))
{
...
if((swatdip ==1 && watid == 1 && solid == 3) || (swatdip ==1 && watid == 3 && solid == 1))
{
  ...
  graph_sAsB_dip(atmS1, atmS3, node1Start, node2Start, nsolvent1, nsolvent3, nAtomS1, nAtomS3, s1s3hbdn, s13a, s13b, s13as13bBD,
...
if((swatdip ==1 && watid == 2 && solid == 3) || (swatdip ==1 && watid == 3 && solid == 2))
{
  ...
  graph_sAsB_dip(atmS2, atmS3, node1Start, node2Start, nsolvent2, nsolvent3, nAtomS2, nAtomS3, s2s3hbdn, s23a, s23b, s23as23bBD,
...
if(gs1t1 == 1)
{
 ...
 if(t1watdip == 1 && watid == 1)
 {
    ...
    graph_st_dip(atmS1, atmT1, node1Start, node2Start, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
...
if(gs1t2 == 1)
{
 ...
 if(t2watdip == 1 && watid == 1)
 {
    ...
    graph_st_dip(atmS1, atmT2, node1Start, node2Start, nsolvent1, nsolute2, nAtomS1, nAtomT2, s1t2cutoffnum, s1t2a, s1t2b, s1t2cutoff,
...
if(gs2t1 == 1)
{
 ...
 if(t1watdip == 1 && watid == 2)
 {
    ...
    graph_st_dip(atmS2, atmT1, node1Start, node2Start, nsolvent2, nsolute1, nAtomS2, nAtomT1, s2t1cutoffnum, s2t1a, s2t1b, s2t1cutoff,
...
if(gs2t2 == 1)
{
 ...
 if(t2watdip == 1 && watid == 2)
 {
    ...
    graph_st_dip(atmS2, atmT2, node1Start, node2Start, nsolvent2, nsolute2, nAtomS2, nAtomT2, s2t2cutoffnum, s2t2a, s2t2b, s2t2cutoff,
...
if(gs3t1 == 1)
{
 ...
 if(t1watdip == 1 && watid == 3)
 {
    ...
    graph_st_dip(atmS3, atmT1, node1Start, node2Start, nsolvent3, nsolute1, nAtomS3, nAtomT1, s3t1cutoffnum, s3t1a, s3t1b, s3t1cutoff,
...
if(gs3t2 == 1)
{
 ...
 if(t2watdip == 1 && watid == 3)
 {
    ...
    graph_st_dip(atmS3, atmT2, node1Start, node2Start, nsolvent3, nsolute2, nAtomS3, nAtomT2, s3t2cutoffnum, s3t2a, s3t2b, s3t2cutoff,
