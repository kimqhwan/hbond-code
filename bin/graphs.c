        ...
        for(crt = 0; crt < s1s1hbdn; crt++)
        {
           ...
           if(dist < s1as1bBD[crt])
           {
                ...
                if(dist < s1as1bBD[crt] && ang < s1s1v6[crt])
                {
                   ...
                   fprintf(outputfGeodS1S1,"%d %d 0 0 0\n",nodei,nodej);
                }
...
// check PBC and include in the graph if requested
 ...
 if(pbc == 1)
 {
   ...
   search_pbc_gss(1, atmS1, atmS1x, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(2, atmS1, atmS1y, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(3, atmS1, atmS1z, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(4, atmS1, atmS1xy, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(5, atmS1, atmS1yz, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(6, atmS1, atmS1zx, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(7, atmS1, atmS1xminy, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(8, atmS1, atmS1minyz, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(9, atmS1, atmS1zminx, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(10, atmS1, atmS1xyz, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(11, atmS1, atmS1xyminz, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(12, atmS1, atmS1minxyz, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);

   search_pbc_gss(13, atmS1, atmS1xminyz, nd1, nsolvent1, nAtomS1, s1s1hbdn, s1a, s1b, s1as1bBD, s1s1hban,
                  s1s1v1, s1s1v2, s1s1v3, s1s1v4, s1s1v5, s1s1v6, outputfGraphS1S1, outputfGeodS1S1);
...
// check PBC and include in the graph if requested
 ...
 if(pbc == 1)
 {
   ...
   search_pbc_gsAsB(1, atmS1, atmS2x, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-1, atmS1, atmS2minx, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(2, atmS1, atmS2y, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-2, atmS1, atmS2miny, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(3, atmS1, atmS2z, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-3, atmS1, atmS2minz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(4, atmS1, atmS2xy, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-4, atmS1, atmS2minxminy, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(5, atmS1, atmS2yz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-5, atmS1, atmS2minyminz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(6, atmS1, atmS2zx, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-6, atmS1, atmS2minzminx, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(7, atmS1, atmS2xminy, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-7, atmS1, atmS2minxy, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(8, atmS1, atmS2minyz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-8, atmS1, atmS2yminz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(9, atmS1, atmS2zminx, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-9, atmS1, atmS2minzx, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(10, atmS1, atmS2xyz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-10, atmS1, atmS2minxminyminz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(11, atmS1, atmS2xyminz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-11, atmS1, atmS2minxminyz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(12, atmS1, atmS2minxyz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-12, atmS1, atmS2xminyminz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(13, atmS1, atmS2xminyz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);

   search_pbc_gsAsB(-13, atmS1, atmS2minxyminz, nd1, nd2, nsolvent1, nsolvent2, nAtomS1, nAtomS2, s1s2hbdn, s12a, s12b, s12as12bBD,
                    s1s2hban, s1s2v1, s1s2v2, s1s2v3, s1s2v4, s1s2v5, s1s2v6, outputfGraphS1S2, outputfGeodS1S2);
...
// check PBC and include in the graph if requested
 ...
 if(pbc == 1)
 {
   ...
   search_pbc_gst(1, atmT1, atmS1x, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-1, atmT1, atmS1minx, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(2, atmT1, atmS1y, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-2, atmT1, atmS1miny, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(3, atmT1, atmS1z, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-3, atmT1, atmS1minz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(4, atmT1, atmS1xy, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-4, atmT1, atmS1minxminy, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(5, atmT1, atmS1yz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-5, atmT1, atmS1minyminz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(6, atmT1, atmS1zx, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-6, atmT1, atmS1minzminx, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(7, atmT1, atmS1xminy, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-7, atmT1, atmS1minxy, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(8, atmT1, atmS1minyz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-8, atmT1, atmS1yminz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(9, atmT1, atmS1zminx, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-9, atmT1, atmS1minzx, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(10, atmT1, atmS1xyz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-10, atmT1, atmS1minxminyminz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(11, atmT1, atmS1xyminz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-11, atmT1, atmS1minxminyz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(12, atmT1, atmS1minxyz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-12, atmT1, atmS1xminyminz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(13, atmT1, atmS1xminyz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);

   search_pbc_gst(-13, atmT1, atmS1minxyminz, nd1, nd2, nsolvent1, nsolute1, nAtomS1, nAtomT1, s1t1cutoffnum, s1t1a, s1t1b, s1t1cutoff,
                  outputfGraphS1T1, outputfGeodS1T1);
        ...
        for(crt = 0; crt < s1s1hbdn; crt++)
        {
           ...
           if(dist < s1as1bBD[crt])
           {
                ...
                if(dist < s1as1bBD[crt] && ang < s1s1v6[crt])
                {
                   ...
                   if(boxid == 1) fprintf(outputfGeodS1S1,"%d %d 1 0 0\n",nodei,nodej);
                   if(boxid == 2) fprintf(outputfGeodS1S1,"%d %d 0 1 0\n",nodei,nodej);
                   if(boxid == 3) fprintf(outputfGeodS1S1,"%d %d 0 0 1\n",nodei,nodej);
                   if(boxid == 4) fprintf(outputfGeodS1S1,"%d %d 1 1 0\n",nodei,nodej);
                   if(boxid == 5) fprintf(outputfGeodS1S1,"%d %d 0 1 1\n",nodei,nodej);
                   if(boxid == 6) fprintf(outputfGeodS1S1,"%d %d 1 0 1\n",nodei,nodej);
                   if(boxid == 7) fprintf(outputfGeodS1S1,"%d %d 1 -1 0\n",nodei,nodej);
                   if(boxid == 8) fprintf(outputfGeodS1S1,"%d %d 0 -1 1\n",nodei,nodej);
                   if(boxid == 9) fprintf(outputfGeodS1S1,"%d %d -1 0 1\n",nodei,nodej);
                   if(boxid == 10) fprintf(outputfGeodS1S1,"%d %d 1 1 1\n",nodei,nodej);
                   if(boxid == 11) fprintf(outputfGeodS1S1,"%d %d 1 1 -1\n",nodei,nodej);
                   if(boxid == 12) fprintf(outputfGeodS1S1,"%d %d -1 1 1\n",nodei,nodej);
                   if(boxid == 13) fprintf(outputfGeodS1S1,"%d %d 1 -1 1\n",nodei,nodej);
